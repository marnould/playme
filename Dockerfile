...
# Multistage build - Declare Commands for php container (declared in docker-compose.yml) and name this block "app_php"
...
# Multistage build - Declare Commands for nginx container (declared in docker-compose.yml) and name this block "app_nginx"
